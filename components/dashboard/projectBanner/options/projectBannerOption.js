...
//for the upadate project option
import { setEditProjectIndex, startEdit } from '/redux/contexts/contextsSlice';
...
export default function ProjectBannnerOption(props) {
    ...
    const onHandleClickUpdateProject = () => {

        dispatch(setEditProjectIndex(props.projectIndex));
        dispatch(startEdit());
        setAnchorEl(null);
    }
    ...
    return (
        <div>
            ...
            >
                ...
                />
                <MenuItem onClick={onHandleClickUpdateProject}>Update Project</MenuItem>
            </Popover>
        </div>
    );
}
